...
(function () {
  ...
  const DICT = {
    de: {
      ...
      "ts.title": "Hilfe bei Problemen",
      "ts.lead": "Die häufigsten Fehler mit Ursache und Lösung.",
      "ts.h.nosshfs": "„sshfs.exe nicht gefunden”",
      "ts.nosshfs.body": "SSHFS-Win ist nicht installiert oder nicht am erwarteten Pfad. Lösung: Installer von",
      "ts.nosshfs.body2": "herunterladen und ausführen.",
      "ts.h.mountpoint": "„mount point in use”",
      "ts.mountpoint.body": "Der gewählte Laufwerksbuchstabe wird noch von einem alten Mount belegt.",
      "ts.mountpoint.li1": "Anderen Laufwerksbuchstaben wählen, oder",
      "ts.mountpoint.li2": "Einstellungen → <em>Veraltete Mounts bereinigen</em>, oder",
      "ts.mountpoint.li3": "Laufwerk im Explorer trennen, oder",
      "ts.mountpoint.li4": "Windows neu starten.",
      "ts.h.authfail": "„Authentifizierung fehlgeschlagen”",
      "ts.authfail.li1": "Passwort prüfen — Verbindung bearbeiten und Passwort neu eingeben.",
      "ts.authfail.li2": "Bei SSH-Key: Ist der Pfad korrekt? Hat der Key eine Passphrase?",
      "ts.authfail.li3": "Am Server: Ist der öffentliche Key in <code>~/.ssh/authorized_keys</code> eingetragen?",
      "ts.h.connrefused": "„Verbindung abgelehnt”",
      "ts.connrefused.body": "SSH-Dienst läuft nicht oder eine Firewall blockiert die Verbindung. Test:",
      "ts.connrefused.body2": "Wenn dieser Test ebenfalls fehlschlägt, ist es kein Problem der App.",
      "ts.h.accessdenied": "Laufwerk erscheint, aber „Zugriff verweigert”",
      "ts.accessdenied.body": "SSHFS-Win neu installieren und prüfen, ob der WinFsp-Dienst läuft (Dienste → WinFsp).",
      "ts.h.nostart": "App startet nicht oder erscheint nicht im Vordergrund",
      "ts.nostart.body": "Es läuft bereits eine Instanz der App. Prüfe das System-Tray — die App ist möglicherweise minimiert. Falls nicht: App im Task-Manager beenden und neu starten.",
      "ts.h.logs": "Logs einsehen",
      "ts.logs.body": "Einstellungen → Debug-Modus aktivieren. Logs werden in <code>%APPDATA%\\SSHWinManager\\app.log</code> gespeichert.",
